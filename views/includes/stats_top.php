...
th.dow{ border-bottom: solid 1px black;}
td.active{background-color:#06F; color:#FFF; font-weight:bold;}
td.old, td.new{	color: #999;}
td.day, th.prev, th.next{	cursor:pointer; font-size: larger;}
td.day:hover{	background-color: #9FF;}

th.prev:hover, th.next:hover{	color: red;}
