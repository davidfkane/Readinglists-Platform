...
<p>
	...
	<?=$book_info->Items->TotalResults; //Output total number of results in Amazon format ?>
</p>
<p>
	Page 
	<?=$page_info['item-page']; //Output page number ?> 
	out of 
	<?=$book_info->Items->TotalPages; //Output total number of pages ?> 
	pages
</p>
<table class="books">
	<tr>
	...
	<tr>
		<td>
			<img src="<?=$book->MediumImage->URL //Link to Thumbnail ?>" alt="Cover of <?=$book->ItemAttributes->Title //Add title of book to alt attribute ?>" class="image-thumbnail" />
			<h3><?=$book->ItemAttributes->Title //Echo title of book ?></h3>
			<p></p><?=$book->ItemAttributes->Author // Echo author of book ?></p>
		</td>
	</tr>
	<?php endforeach; ?>
</table>
